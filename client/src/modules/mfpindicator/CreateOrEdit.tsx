...
import {
    useMfpIndicatorByIdLazyQuery as useByIdLazyQuery,
    useMfpIndicatorCreateOneMutation as useCreateOneMutation,
    useMfpIndicatorUpdateByIdMutation as useUpdateByIdMutation,
    MfpIndicatorManyDocument as ManyDocument,
    MfpIndicatorByIdQuery as ByIdQuery,
    MfpIndicatorCreateOneMutation as CreateOneMutation,
} from '../../generated/graphql';

const parseCreateOneResponse = (data?: CreateOneMutation) =>
    data?.MfpIndicatorCreateOne;

const parseByIdResponse = (data?: ByIdQuery) =>
    data?.MfpIndicatorById;

const redirectToAllItemsPath = () =>
    routeConfig.MfpIndicatorMany.path;
